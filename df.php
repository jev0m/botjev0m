...
$channel = "jev0m_store";
$admin = 610569681;
$channelcode = "l23gift"; // ايدي القناة الي ترسل بيها لهدايا
$token = API_KEY;
...
iiiiZ('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"- La Botaka Bannd krawe ، ⚖ !
- Ba hoy jebaje nakrdne botaka tkaya nama manerawa 🔱
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎",
...
iiiiZ('sendmessage',[
	'chat_id'=>$admin,
	'text'=>"- Bannd krawe nama bo bot bnera ،
...
iiiiZ('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"• Baxerbey ؛ [$name](tg://user?id=$chat_id)

- Bo bote zyad krdne andam ، 📻 '
- Dast bak ba kokrdnawya point bo krene andam bo chanalakt ، ⚖ '
- Ko krdnaway point ba link bo xalk bnerey yan subscribe krdne chanale tr ، 💸 '
- lam dwgmanay xwarawa xwaste xot dyare bka ، 🔰 ؛
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
[My channel ، 📢](https://t.me/jev0m_store)",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
   	'reply_markup'=>json_encode([
  	'inline_keyboard'=>[
   [
   ['text'=>"- Ko krdnaway point ، 📻 '",'callback_data'=>'takecoin']
   ],
    [
   ['text'=>"- Krene andam ، 💸 '",'callback_data'=>'takemember'],['text'=>"- Hazhmare pointakant ، 📊 '",'callback_data'=>'accont']
   ],
   [
   ['text'=>"- Linke xot ، 📧 '",'callback_data'=>'member'],['text'=>"- Gorene point ، ♻️ '",'callback_data'=>'sendcoin']
   ],
      [
   ['text'=>"- Dawa krdne shtek ، 🇮🇶 '",'callback_data'=>'sup'],
   ],
  	],
...
iiiiZ('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"• To subcribet krdwa ، 📌 !
• Natwane jareke tr link bkyawa yan subscribe bkay ، ⚜ '
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎",
	   	'reply_markup'=>json_encode([
  	'inline_keyboard'=>[
   [
